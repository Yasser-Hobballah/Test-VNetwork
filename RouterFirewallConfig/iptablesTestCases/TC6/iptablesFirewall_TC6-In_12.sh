...
${cmd} -P FORWARD DROP
${cmd} -P OUTPUT DROP
${cmd} -A FORWARD -p tcp -s 10.0.2.3/32 -d 30.0.5.2/32 --sport 1000 --dport 400 -j DROP
${cmd} -A FORWARD -p tcp -s 30.0.5.2/32 -d 10.0.2.3/32 --sport 400 --dport 1000 -j DROP
${cmd} -A FORWARD -p udp -s 10.0.2.3/32 -d 30.0.5.2/32 --sport 1000 --dport 400 -j DROP
${cmd} -A FORWARD -p udp -s 30.0.5.2/32 -d 10.0.2.3/32 --sport 400 --dport 1000 -j DROP
