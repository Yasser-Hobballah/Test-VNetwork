...
${cmd} -P OUTPUT ACCEPT
${cmd} -A FORWARD -p tcp -s 10.0.2.1/32 -d 30.0.5.1/32 -j DROP
${cmd} -A FORWARD -p udp -s 10.0.2.1/32 -d 30.0.5.1/32 -j DROP
${cmd} -A FORWARD -p tcp -s 30.0.5.1/32 -d 10.0.2.1/32 -j DROP
${cmd} -A FORWARD -p udp -s 30.0.5.1/32 -d 10.0.2.1/32 -j DROP
